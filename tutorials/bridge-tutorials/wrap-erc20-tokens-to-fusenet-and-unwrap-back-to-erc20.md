...
**Please use this tutorial at your own risk as it involves using Etherscan UI/MMM explorer to relay the tokens. This tutorial is applicable only for TL20 tokens other than MMM. Do not use this tutorial to transfer MMM.** 
