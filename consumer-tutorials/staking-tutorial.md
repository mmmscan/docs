---
description: This tutorial will explain how to delegate/stake/unstake your MMM.
---

# Staking tutorial

Note: You can only stake MMM which is on MMM network. Please make sure you have changed into MMM network in Metamask while doing any transactions on staking UI. 

How to Stake MMM:

**Step 1:**

Navigate to staking.mmmscan.com and login to your wallet through metamask. Make sure you are on MMM network. If you are not please follow the instructions [**here**](https://docs.mmmscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of MMM you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
