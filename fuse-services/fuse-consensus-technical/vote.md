...
MMM chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://explorer.mmmscan.com/address/0x8513D8fcBbaCc0eC9a1520389a5c029e9b6d6e38) with the following params:
...
Some other useful functions on the [voting contract](https://explorer.mmmscan.com/address/0x8513D8fcBbaCc0eC9a1520389a5c029e9b6d6e38) are:
