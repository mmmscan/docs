...
The MMM Studio REST API for accessing the data and the services of the MMM network in a simple way. You can use this API to query and interact with the objects of the MMM network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and MMM network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(MMM\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the MMM network |
...
| homeBridgeAddress | `String` | Bridge address on the MMM network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the MMM network |
...
Community is a set of contracts and services. Members of the community are users of the MMM network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the MMM network |
| homeTokenAddress | `String` | Address of the community token on the MMM network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the MMM network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the MMM network |
...
Entity is an account on the MMM network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on MMM network |
